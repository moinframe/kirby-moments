...
> You can customize the slug being used through the [configuration](/docs/moinframe-moments/02-configuration). If you change the slug after initialization, be sure to delete the previously generated page.
