...
You can remove the scripts by setting `'moinframe.moments.lightbox' => false` in your `config.php`. See the [configuration](/docs/moinframe-moments/03-configuration) for more information.
